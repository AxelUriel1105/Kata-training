...
solve("coDE") = "code". Upper == lowercase. Change all to lowerc"""
def solve(s):
    countUpper = sum(1 for i in s if i.isupper())
    return s.lower() if countUpper <= len(s) - countUpper else s.upper()
