...
"""
vowDict = {'a':'1','e':'2','i':'3','o':'4','u':'5'}
numDict = {'1':'a','2':'e','3':'i','4':'o','5':'u'}
def encode(st):
    return "".join(i if i.lower() not in vowDict else vowDict.get(i.lower()) for i in st)
    
def decode(st):
    return "".join(i if not i.isdigit() else numDict.get(i) for i in st)