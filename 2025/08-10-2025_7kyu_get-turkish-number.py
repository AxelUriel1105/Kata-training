...
def get_turkish_number(num):
	return turkish_numbers.get(num) if len(str(num))==1 else turkish_numbers.get(num) if str(num)[1] == '0' else turkish_numbers.get(int(str(num)[0]+'0'))+ ' ' + turkish_numbers.get(int(str(num)[-1])) 