"""There is a bus moving in the city which takes and drops some
 people at each bus stop.
...
def number(bus_stops):
    return sum([bus_stops[i][0] - bus_stops[i][1] for i in range(0,len(bus_stops))])
