"""In this kata you will have to write a function that takes litres and price_per_litre
...
def fuel_price(litres, price_per_litre):
    discount = 0.05*(litres//2)
    FinalDiscount = {discount < 0.25: discount,discount>= 0.25: 0.25 }
    return litres*price_per_litre - litres*FinalDiscount[True]
